...
namespace Lib.Dogecoin.Interop
{
    ...
    internal static class LibDogecoinInterop
    {
        ...
        [DllImport(DLL_NAME, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        internal static unsafe extern working_transaction* find_transaction(
            int txindex
        );

        [DllImport(DLL_NAME, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        internal static unsafe extern int dogecoin_tx_add_data_out(
            dogecoin_tx* tx,
            long amount,
            [In] byte[] data,
            int datalen);
        ...
        [DllImport(DLL_NAME, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static unsafe extern bool dogecoin_script_get_ops(cstring* script_in, vector* ops_out);

        [DllImport(DLL_NAME, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern void dogecoin_script_op_free(IntPtr script_op);

        [DllImport(DLL_NAME, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern void dogecoin_tx_free(IntPtr dogecoin_tx);
